...
function replaceIt() {
    ...
    var preposition = "<span class='replacement'>" + document.getElementById("preposition").value + "</span>";
    var family = "<span class='replacement'>" + document.getElementById("family").value + "</span>";
    ...
    theStory += "He went " + preposition + " home to show his " + family + ".<br><br>";
